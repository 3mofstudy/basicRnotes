...
```{r echo=TRUE}
Sys.setlocale("LC_TIME", locale ="English")  # 也可以用 en.UTF-8
...
+----------+-----------------------------------------------------+--------------------------+
| 國家語系 | 語系設定                                            | format(Sys.Date(), "%A") |
|          |                                                     |                          |
|          |                                                     | 範例輸出                 |
+==========+=====================================================+:========================:+
| 日本     | Sys.setlocale("LC_TIME", locale =**"ja_JP.UTF-8"**) | "土曜日"                 |
+----------+-----------------------------------------------------+--------------------------+
| 韓國     | Sys.setlocale("LC_TIME", locale =**"ko_KR.UTF-8"**) | "토요일"                 |
+----------+-----------------------------------------------------+--------------------------+
| 德語     | Sys.setlocale("LC_TIME", locale =**"de_DE.UTF-8"**) | "Samstag"                |
+----------+-----------------------------------------------------+--------------------------+
| 俄語     | Sys.setlocale("LC_TIME", locale =**"ru_RU.UTF-8"**) | "суббота"                |
+----------+-----------------------------------------------------+--------------------------+
| 西班牙語 | Sys.setlocale("LC_TIME",locale =**"es_ES.UTF-8"**)  | "sábado"                 |
+----------+-----------------------------------------------------+--------------------------+
| 泰語     | Sys.setlocale("LC_TIME", locale =**"th_TH.UTF-8"**) | "เสาร์"                   |
+----------+-----------------------------------------------------+--------------------------+
| 越南語   | Sys.setlocale("LC_TIME", locale =**"vi_VN.UTF-8"**) | "Thứ Bảy"                |
+----------+-----------------------------------------------------+--------------------------+
