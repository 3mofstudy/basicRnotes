...
```{r plot-8.2, message=FALSE, warning=FALSE}
...
```{r plot-8.3, message=FALSE, warning=FALSE}
...
```{r plot-8.4, message=FALSE, warning=FALSE}
# 顏色示範
par(mfrow = c(2, 2))
...
```{r plot-8.5, message=FALSE, warning=FALSE}
# 設定圖形佈局
...
```{r plot-8.6, message=FALSE, warning=FALSE}
# 直方圖
set.seed(123)
...
```{r plot-8.7, message=FALSE, warning=FALSE}
# 盒鬚圖
par(mfrow = c(2, 2))
...
```{r plot-8.8, message=FALSE, warning=FALSE}
# 長條圖
par(mfrow = c(2, 2))
...
```{r plot-8.9, message=FALSE, warning=FALSE}
# 圓餅圖
par(mfrow = c(2, 2))
...
```{r plot-8.10, message=FALSE, warning=FALSE}
# 基礎多圖佈局
...
```{r plot-8.11, message=FALSE, warning=FALSE}
# 自訂佈局
...
```{r plot-8.12, message=FALSE, warning=FALSE}
# 圖形註解
...
```{r plot-8.13, message=FALSE, warning=FALSE}
# 線條和形狀
